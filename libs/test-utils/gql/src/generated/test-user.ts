...
const GetUserByEmailDocument = `
  ...
  users(where: {email: {_eq: $email}}) {
    ...
    ${UserFieldsFragmentDoc}`;
const GetWalletsByAddressDocument = `
  ...
  Wallet(where: {address: {_eq: $address}}) {
    ...
    `;
const SubscribeWalletsByAddressDocument = `
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    balancesEIP377(
      ...
      options?: C
    ): Promise<BalancesEip377Query> {
      return requester<BalancesEip377Query, BalancesEip377QueryVariables>(
        BalancesEip377Document,
        variables,
        options
      ) as Promise<BalancesEip377Query>;
    },
    ...
    getWalletsByAddress(
      ...
      options?: C
    ): Promise<GetWalletsByAddressQuery> {
      return requester<GetWalletsByAddressQuery, GetWalletsByAddressQueryVariables>(
        GetWalletsByAddressDocument,
        variables,
        options
      ) as Promise<GetWalletsByAddressQuery>;
    },
    subscribeWalletsByAddress(
      variables: SubscribeWalletsByAddressSubscriptionVariables,
      options?: C
    ): AsyncIterable<SubscribeWalletsByAddressSubscription> {
      return requester<
        SubscribeWalletsByAddressSubscription,
        SubscribeWalletsByAddressSubscriptionVariables
      >(
        SubscribeWalletsByAddressDocument,
        variables,
        options
      ) as AsyncIterable<SubscribeWalletsByAddressSubscription>;
    },
  };
}
